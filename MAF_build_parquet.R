...
# load eqtl data
ds_maf <- open_dataset("db/eqtl_MAF/2018-07-18_SNP_AF_for_AlleleB_combined_allele_counts_and_MAF_pos_added.txt", format = "tsv")
...
file.remove("db/eqtl_MAF/2018-07-18_SNP_AF_for_AlleleB_combined_allele_counts_and_MAF_pos_added.txt")